...
/**
 * ConfigReader - Classe para ler propriedades do arquivo config.properties
 */
public class ConfigReader {
    ...
    /**
     * Obtém valor de propriedade por chave
     */
    ...
    /**
     * Obtém valor de propriedade com valor padrão
     */
    ...
    /**
     * Obtém propriedade como inteiro
     */
    ...
    /**
     * Obtém propriedade como booleano
     */
    public static boolean getBooleanProperty(String key) {
        return Boolean.parseBoolean(properties.getProperty(key));
    }

    // Métodos convenientes para configurações comuns
